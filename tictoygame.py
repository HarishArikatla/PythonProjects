# -*- coding: utf-8 -*-
"""
Created on Mon Aug 24 16:22:39 2020
...
def CheckWinner():
    ...
    if winner ==1:
        messagebox.showinfo(title="Congratulations!",
            message="First Player hari is the winner")
    elif winner ==2:
        messagebox.showinfo(title="Congratulations!",
            message="Second Player  arjun is the winner")
    elif mov ==9:
