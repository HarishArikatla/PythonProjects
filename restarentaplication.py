# -*- coding: utf-8 -*-
"""
Created on Sun Sep 13 14:42:02 2020
...
root = Tk()
root.geometry("1050x750+0+0")
root.title("HARI Restaurant ")
root.configure(background='green')

Tops = Frame(root, bg='green', bd=20, pady=5, relief=RIDGE)
Tops.pack(side=TOP)

lblTitle = Label(Tops, font=('arial', 60, 'bold'), text='HARI$ARJUN RESTAURANT ', bd=21, bg='black',
